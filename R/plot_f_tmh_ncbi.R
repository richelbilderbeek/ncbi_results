...
plot_f_tmh_ncbi <- function(
  ...
  n_variations_tmp_in_tmh <- sum(t_results_tmps$is_in_tmh)
  n_snps_in_soluble <- sum(!t_results_tmps$is_in_tmh)
  testthat::expect_equal(ncbiresults::get_n_variations_tmp_in_tmh(), n_variations_tmp_in_tmh)
  testthat::expect_equal(ncbiresults::get_n_variations_tmp_in_sol(), n_snps_in_soluble)
  testthat::expect_equal(n_snps_in_tmp, n_variations_tmp_in_tmh + n_snps_in_soluble)
